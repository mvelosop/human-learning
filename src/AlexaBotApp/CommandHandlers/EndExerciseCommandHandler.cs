...
{
    public class RegisterUtteranceCommandHandler : ICommandHandler<RegisterUtteranceCommand, PhraseExercise>
    {
        ...
        public async Task<PhraseExercise> HandleAsync(RegisterUtteranceCommand command)
        {
